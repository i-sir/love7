 ...
 *     "version"             =>"1.0",
 *     "use"                 => new \app\admin\controller\LoveNoticeController();
 * )
 */
...
class LoveNoticeController extends AdminBaseController
{
    ...
    protected function base_index()
    {
        ...
        $this->assign('type_list', $LoveNoticeInit->type);
    }
    ...
    public function index()
    {
        ...
        if ($params["matchmaker_id"]) $where[] = ["matchmaker_id", "=", $params["matchmaker_id"]];
    ...
    public function edit()
    {
        ...
        $mate_info = $LoveMateInit->get_find($where);
        $this->assign('mate_info', $mate_info);
    ...
    public function edit_post()
    {
        ...
        //提交数据
        $result = $LoveNoticeInit->admin_edit_post($params, $where);
    ...
    public function edit_post_two()
    {
        ...
        //提交数据
        $result = $LoveNoticeInit->edit_post_two($params, $where);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function add_post()
    {
        ...
        if ($params['user1']) $params['send_user_id'] = $params['user_id'];
        if ($params['user2']) $params['send_user_id'] = $params['to_user_id'];
        if ($params['user1'] && $params['user2']) $params['send_user_id'] = "{$params['user_id']},{$params['to_user_id']}";
        ...
        //插入数据
        $result = $LoveNoticeInit->admin_edit_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function delete()
    {
        ...
        //删除数据
        $result = $LoveNoticeInit->delete_post($id);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function batch_post()
    {
        ...
        //提交编辑
        $result = $LoveNoticeInit->batch_post($id, $params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function list_order_post()
    {
        ...
        //提交更新
        $result = $LoveNoticeInit->list_order_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function export_excel($where = [], $params = [])
    {
        ...
        $result = $LoveNoticeInit->get_list($where, $params);
