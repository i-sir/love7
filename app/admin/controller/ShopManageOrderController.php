 ...
 *     "controller_name"     =>"ShopManageOrder",
 ...
 *     "version"             =>"1.0",
 *     "use"                 => new \app\admin\controller\ShopManageOrderController();
 * )
 */
...
class ShopManageOrderController extends AdminBaseController
{
...
//    }
    ...
    public function index()
    {
        ...
        //查询条件
        $where = [];
        if ($params["keyword"]) $where[] = ["shop_id|user_id|order_num", "like", "%{$params["keyword"]}%"];
        $where[] = ["status", "=", 2];
        ...
        //查询数据
        $result = $ShopManageOrderInit->get_list_paginate($where, $params);
    ...
    public function edit()
    {
        ...
        //查询数据
        $params["InterfaceType"] = "admin";//接口类型
        $result                  = $ShopManageOrderInit->get_find($where, $params);
    ...
    public function edit_post()
    {
        ...
        //提交数据
        $result = $ShopManageOrderInit->admin_edit_post($params, $where);
    ...
    public function edit_post_two()
    {
        ...
        //提交数据
        $result = $ShopManageOrderInit->edit_post_two($params, $where);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function add_post()
    {
        ...
        //插入数据
        $result = $ShopManageOrderInit->admin_edit_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function delete()
    {
        ...
        //删除数据
        $result = $ShopManageOrderInit->delete_post($id);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function batch_post()
    {
        ...
        //提交编辑
        $result = $ShopManageOrderInit->batch_post($id, $params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function list_order_post()
    {
        ...
        //提交更新
        $result = $ShopManageOrderInit->list_order_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function export_excel($where = [], $params = [])
    {
        ...
        $result = $ShopManageOrderInit->get_list($where, $params);
