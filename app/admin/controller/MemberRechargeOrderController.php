 ...
 *     "controller_name"     =>"MemberRechargeOrder",
 ...
 *     "remark"              =>"充值订单",
 *     "author"              =>"",
 *     "create_time"         =>"2024-08-26 15:28:33",
 *     "version"             =>"1.0",
 *     "use"                 => new \app\admin\controller\MemberRechargeOrderController();
 * )
 */
...
class MemberRechargeOrderController extends AdminBaseController
{
...
//    }
    ...
    public function index()
    {
        ...
        //查询数据
        $result = $MemberRechargeOrderInit->get_list_paginate($where, $params);
    ...
    public function edit()
    {
        ...
        //查询数据
        $params["InterfaceType"] = "admin";//接口类型
        $result                  = $MemberRechargeOrderInit->get_find($where, $params);
    ...
    public function edit_post()
    {
        ...
        //提交数据
        $result = $MemberRechargeOrderInit->admin_edit_post($params, $where);
    ...
    public function edit_post_two()
    {
        ...
        //提交数据
        $result = $MemberRechargeOrderInit->edit_post_two($params, $where);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function add_post()
    {
        ...
        //插入数据
        $result = $MemberRechargeOrderInit->admin_edit_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function delete()
    {
        ...
        //删除数据
        $result = $MemberRechargeOrderInit->delete_post($id);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function batch_post()
    {
        ...
        //提交编辑
        $result = $MemberRechargeOrderInit->batch_post($id, $params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function list_order_post()
    {
        ...
        //提交更新
        $result = $MemberRechargeOrderInit->list_order_post($params);
        if (empty($result)) $this->error("失败请重试");
    ...
    public function export_excel($where = [], $params = [])
    {
        ...
        $result = $MemberRechargeOrderInit->get_list($where, $params);
